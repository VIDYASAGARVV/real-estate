        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <p className="text-gray-800 mb-6 font-medium">
              At Adhwaitha Constructions, we understand that precision is key.
              We ensure that every detail—whether it’s a facade, glass fitting,
              or structural element—fits seamlessly into your design vision,
              delivering a flawless and functional result every time.
            </p>
          </div>
        </div>
      </section>
